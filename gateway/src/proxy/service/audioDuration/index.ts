 ...
 *
 * Maintained locally by the OpenAI gateway. Originally adapted from the
 * MIT-licensed `@livepeer-network/audio-duration` implementation at
 * Cloud-SPE/livepeer-network-modules commit 2666f19.
 *
 ...
 * to reach the same number the broker will bill. This local implementation
 * follows the advertised estimator id, rounding, and exactness contract.
 * Conformance vectors protect that wire-level agreement; package identity
 * and source-tree layout are not part of the runtime contract.
 *
